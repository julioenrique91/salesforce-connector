...
/**
 * GetServerTimestampMessageProcessor invokes the {@link org.mule.modules.salesforce.BaseSalesforceConnector#getServerTimestamp()} method in {@link BaseSalesforceConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-04-15T08:29:18-05:00", comments = "Build master.1915.dd1962d")
public class GetServerTimestampMessageProcessor
    extends AbstractConnectedProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public GetServerTimestampMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BaseSalesforceConnector) object).getServerTimestamp();
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at SalesforceOAuthConnector at getServerTimestamp retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
