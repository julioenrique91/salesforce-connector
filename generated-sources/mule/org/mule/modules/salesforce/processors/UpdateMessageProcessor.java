    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public Result<MetaData> getInputMetaData() {
        if (((type) == null)||((type).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: type at processor update at module SalesforceConnector");
        }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at SalesforceConnector at update retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
