    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public SetPasswordMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((BaseSalesforceConnector) object).setPassword(_transformedUserId, _transformedNewPassword);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at SalesforceOAuthConnector at setPassword retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
